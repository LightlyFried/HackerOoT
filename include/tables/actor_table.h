...
/* [ EM ] */ DEFINE_ACTOR(Em_Spell_Projectile, ACTOR_EM_SPELL_PROJECTILE, ACTOROVL_ALLOC_NORMAL, "Em_Spell_Projectile")
/* 0x01D6 */ DEFINE_ACTOR(Em_Title_Card, ACTOR_EM_TITLE_CARD, ACTOROVL_ALLOC_NORMAL, "Em_Title_Card")
