...
/* [ UI ] */ DEFINE_ACTOR(Em_Title_Card, ACTOR_EM_TITLE_CARD, ACTOROVL_ALLOC_NORMAL, "Em_Title_Card")
/* [ UI ] */ DEFINE_ACTOR(Ui_Sample_Screen, ACTOR_UI_SAMPLE_SCREEN, ACTOROVL_ALLOC_NORMAL, "Ui_Sample_Screen")